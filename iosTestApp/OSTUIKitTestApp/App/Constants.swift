...
enum Organizations {
    static let sdkTesting = Organization(
        ...
        apiKey: "REDACTED-SDK-TESTING-API-KEY",
        identityVerificationSecret: "REDACTED-SDK-TESTING-IDENTITY-SECRET"
    )
    ...
    static let zimmerDev = Organization(
        ...
        apiKey: "REDACTED-ZIMMER-DEV-API-KEY",
        identityVerificationSecret: "REDACTED-ZIMMER-DEV-IDENTITY-SECRET"
    )
    ...
    static let appClip = Organization(
        ...
        apiKey: "REDACTED-APP-CLIP-API-KEY",
        identityVerificationSecret: "REDACTED-APP-CLIP-IDENTITY-SECRET"
    )
