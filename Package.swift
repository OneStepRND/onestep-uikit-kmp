...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "OSTUIKit",
            url: "https://github.com/OneStepRND/onestep-uikit-kmp/releases/download/uikit-kmp-0.6.23-SNAPSHOT/OSTUIKit.xcframework.zip",
            checksum: "85c684bbe6a761eeea06ae31f02cca243671af18caeb984006bd4252cd40df05"
        ),
        .target(
