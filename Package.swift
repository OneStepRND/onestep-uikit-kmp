...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "OSTUIKit",
            url: "https://github.com/OneStepRND/onestep-uikit-kmp/releases/download/uikit-kmp-0.6.2-SNAPSHOT/OSTUIKit.xcframework.zip",
            checksum: "72106f1788de0338c79470610be93cebea00f090e4928444da71d77b076d2c45"
        ),
        .target(
