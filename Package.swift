...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "OSTUIKit",
            url: "https://github.com/OneStepRND/onestep-uikit-kmp/releases/download/uikit-kmp-0.6.17-SNAPSHOT/OSTUIKit.xcframework.zip",
            checksum: "2ff9b6ea2f9c1cd3c55cc2585fc3ba1819dff94b02a7985bc56da7954b5bfe55"
        ),
        .target(
