...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "OSTUIKit",
            url: "https://github.com/OneStepRND/onestep-uikit-kmp/releases/download/uikit-kmp-0.6.25-SNAPSHOT/OSTUIKit.xcframework.zip",
            checksum: "e97f8d1f37202102071843baaa045dd766c4de2b0027c99737750a50804b5ca3"
        ),
        .target(
