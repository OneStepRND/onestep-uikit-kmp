...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "OSTUIKit",
            url: "https://github.com/OneStepRND/onestep-uikit-kmp/releases/download/uikit-kmp-0.4.0/OSTUIKit.xcframework.zip",
            checksum: "198acac1a05d48e576b957dd36140fe7740a88b14e7c6b44e91a5b3eca43707f"
        ),
        .target(
